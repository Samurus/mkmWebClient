...
public class Article implements CardMarketArticle {
    ...
    public Article(Integer articleId, Integer productId, LanguageCode languageCode, String comment, BigDecimal price,
     ...
     * @param playset
     */
    public Article(Integer productId, LanguageCode languageCode, String comment, BigDecimal price, int quantity, Condition condition, boolean foil, boolean signed, boolean playset) {
        this.productId = productId;
        this.languageCode = languageCode;
        this.comment = comment;
        this.price = price;
