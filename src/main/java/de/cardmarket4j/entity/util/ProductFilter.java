...
/**
 * This class represents the filter function for products on cardmarket. Filters are only activated
...
public class ProductFilter {
  ...
  public String toString() {
    return "ProductFilter [" + (searchQuery != null ? "searchQuery=" + searchQuery + ", " : "")
        + "exact=" + exact
        + ", " + (game != null ? "game=" + game + ", " : "")
