...
public class Order {
  ...
  public Order(int orderId, boolean isBuyer, User seller, User buyer, OrderState orderState,
      LocalDateTime dateBought,
      LocalDateTime datePaid, LocalDateTime dateSent, LocalDateTime dateReceived,
      LocalDateTime dateCanceled,
      String cancellationReason, Integer mergedOrderId, ShippingMethod shippingMethod,
      String trackingNumber,
      boolean isPresale, Address shippingAddress, int amountItems, String note,
  ...
  public String toString() {
    return "Order [orderId=" + orderId + ", isBuyer=" + isBuyer + ", "
        ...
        + (trackingNumber != null ? "trackingNumber=" + trackingNumber + ", " : "") + "isPresale="
        + isPresale
