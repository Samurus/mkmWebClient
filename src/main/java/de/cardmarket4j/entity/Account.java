...
public class Account extends User {
  ...
  public Account(int userId, String userName, LocalDateTime registrationDate, UserType userType,
      boolean seller,
      String companyName, String firstName, String lastName, Address address, String phoneNumber,
      String emailAddress, String vat, RiskGroup riskGroup, Reputation reputation,
    ...
    super(userId, userName, registrationDate, userType, seller, companyName, firstName, lastName,
        address,
  ...
  public int hashCode() {
    ...
    result =
        prime * result + ((providerRechargeAmount == null) ? 0 : providerRechargeAmount.hashCode());
    result =
        prime * result + ((sellerActivationStatus == null) ? 0 : sellerActivationStatus.hashCode());
  ...
  public String toString() {
    return "Account [" + (country != null ? "country=" + country + ", " : "") + "maySell=" + maySell
        ...
        + ", " : "")
        + (deliverySpeed != null ? "deliverySpeed=" + deliverySpeed + ", " : "") + "activated="
        + activated
