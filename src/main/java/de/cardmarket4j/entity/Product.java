...
public class Product {
  ...
  public int hashCode() {
    ...
    result = prime * result + ((expansionCollectionNumber == null) ? 0
        : expansionCollectionNumber.hashCode());
    result = prime * result + ((expansionName == null) ? 0 : expansionName.hashCode());
    result = prime * result + ((game == null) ? 0 : game.hashCode());
    result = prime * result + ((imageUrl == null) ? 0 : imageUrl.hashCode());
    result =
        prime * result + ((listReprintProductIds == null) ? 0 : listReprintProductIds.hashCode());
  ...
  public String toString() {
    return "Product [" + (productId != null ? "productId=" + productId + ", " : "")
        ...
        + ", " : "")
        + (expansionCollectionNumber != null ? "expansionCollectionNumber="
