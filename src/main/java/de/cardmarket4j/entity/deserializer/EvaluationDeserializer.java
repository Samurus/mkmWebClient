...
public class EvaluationDeserializer implements JsonDeserializer<Evaluation> {
  ...
  public Evaluation deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context)
    ...
    EvaluationGrade totalGrade = EvaluationGrade
        .parseId(JsonIO.parseInteger(jObject, "evaluationGrade"));
    EvaluationGrade itemGrade = EvaluationGrade
        .parseId(JsonIO.parseInteger(jObject, "itemDescription"));
    EvaluationGrade packagingGrade = EvaluationGrade
        .parseId(JsonIO.parseInteger(jObject, "packaging"));
