...
public class AuthenticationService {
  ...
  public AuthenticationService(String appToken, String appSecret, String accessToken,
  ...
  public String createOAuthSignature(String url, HTTPMethod method)
    ...
    String signatureKey =
        URLEncoder.encode(appSecret, encode) + "&" + URLEncoder.encode(accessTokenSecret, encode);
